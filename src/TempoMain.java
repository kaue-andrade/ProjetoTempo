...
public class TempoMain { //Cria a classe pública denominada TempoMain
    public static void main(String[] args) { //public: modificador de acesso do método público; static: estático; void: sem retorno; main (principal): nome do método; (String[] args): receber como parâmetro um array de String (denominado args).
        ...
        Tempo t1 = new Tempo(14, 00, 00); //Criação do t2 e estabelecimento dos valores
        ...
        if (t1.setHora(01)){ //Define a nova hora de t1 (é possível vermos o valor escolhido entre parênteses)
        ...
        if (t1.setMinutos(00)){ //Define o(s) novo(s) minutos de t1 (é possível vermos o valor escolhido entre parênteses)
        ...
        System.out.println("\nDIFERENÇA ENTRE OS DOIS HORÁRIOS: " + t1.diferencaTempo(t2) + " segundo(s)"); //Exibe a diferença entre os dois tempo (t1 e t2) em segundos
    }
}